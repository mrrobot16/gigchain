...
describe("Organization Contract", function () {
  ...
  this.beforeAll(async () => {
    OrganizationContract = await ethers.getContractFactory(ORGANIZATION_CONTRACT);
    organization = await OrganizationContract.deploy(ORGANIZATION_NAME_TEST, members, { value: ORGANIZATION_DEPOSIT_TEST });
  ...
  describe("Members", function () {
    ...
    it("Should not find a random member", async function () {
      const getMember = await organization.getMember(RANDOM_MEMBER_ADDRESS);
